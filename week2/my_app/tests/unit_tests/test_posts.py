...
class TestPostService(unittest.TestCase):
    ...
    def test_get_post_not_found(self):
        post_data = get_post(9999)  # Assuming this ID doesn't exist
    ...
    def test_update_post_not_found(self):
        ...
        with self.assertRaises(ValueError):
            update_post(9999, data)  # Assuming this ID doesn't exist
    ...
    def test_delete_post(self):
        ...
        deleted_post = self.session.query(Post).filter_by(id=post.id).first()
        self.assertIsNone(deleted_post)

    def test_delete_post_not_found(self):
        response = delete_post(9999)  # Assuming this ID doesn't exist
